...
export default function Home() {
  ...
  const importExample = () => { const target = accounts.find(account => String(account.id) === importAccountId); if (!target) { setNotice("스크린샷을 반영할 계좌를 선택해 주세요."); return; } setImportOpen(false); setNotice(`“${target.name}” 계좌에 스크린샷을 등록했습니다. 실제 인식 결과를 확인한 뒤 반영할 수 있도록 준비 중입니다.`); };
