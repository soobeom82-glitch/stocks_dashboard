...
type Holding = { symbol: string; name: string; quantity: number; averagePrice: number; fallbackPrice: number; accountId?: number; unit?: string; assetClass?: "ETF·주식" | "현금성·금융상품" };
...
function AccountDetails({ account, holdings, coinHoldings, pensionHoldings, isaHoldings, irpHoldings, quoteUpdatedAt, coinQuoteUpdatedAt, isaQuoteUpdatedAt, refreshPrices, refreshCoinPrices, refreshIsaPrices }: { account: Account; holdings: Holding[]; coinHoldings: CoinHolding[]; pensionHoldings: PensionHolding[]; isaHoldings: Holding[]; irpHoldings: Holding[]; quoteUpdatedAt: string; coinQuoteUpdatedAt: string; isaQuoteUpdatedAt: string; refreshPrices: () => Promise<void>; refreshCoinPrices: () => Promise<void>; refreshIsaPrices: () => Promise<void> }) {
  ...
  const updatedAt = isDomestic ? quoteUpdatedAt : isCoin ? coinQuoteUpdatedAt : isaQuoteUpdatedAt;
  const refresh = isDomestic ? refreshPrices : isCoin ? refreshCoinPrices : refreshIsaPrices;
